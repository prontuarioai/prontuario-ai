...
export default function PrecosPage() {
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      {/* Nav */}
      <nav className="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700 px-6 py-4">
        <div className="max-w-5xl mx-auto flex items-center justify-between">
          <Link href="/" className="text-lg font-bold text-brand-700">Agenda Online AI</Link>
          <div className="flex gap-3">
            <Link href="/login" className="text-sm text-gray-600 dark:text-gray-300 hover:text-gray-900 dark:text-white px-4 py-2 rounded-xl hover:bg-gray-50 dark:bg-gray-900 transition-colors">
              Entrar
            </Link>
      ...
      <div className="max-w-5xl mx-auto px-6 py-16 space-y-16">
        ...
        <div className="text-center space-y-4">
          <h1 className="text-4xl font-bold text-gray-900 dark:text-white">Simples e transparente</h1>
        ...
        {/* Card de preço */}
        <div className="max-w-sm mx-auto bg-white dark:bg-gray-800 rounded-3xl border border-gray-100 dark:border-gray-700 shadow-sm p-8 space-y-6">
          <div>
            <p className="text-sm font-medium text-brand-600 mb-1">Plano único</p>
            <div className="flex items-baseline gap-1">
              <span className="text-4xl font-bold text-gray-900 dark:text-white">R$ 29</span>
              <span className="text-xl font-bold text-gray-900 dark:text-white">,90</span>
              <span className="text-gray-400 text-sm">/mês</span>
            </div>
            <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">+ R$ 2,99 por paciente ativo/mês</p>
          </div>
        ...
        <div className="max-w-2xl mx-auto space-y-6">
          <h2 className="text-2xl font-bold text-gray-900 dark:text-white text-center">Perguntas frequentes</h2>
          {[
            ...
            <div key={item.q} className="bg-white dark:bg-gray-800 rounded-2xl border border-gray-100 dark:border-gray-700 p-5">
        ...
        {/* CTA final */}
        <div className="text-center space-y-4">
          <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Pronto para começar?</h2>
          <p className="text-gray-500 dark:text-gray-400">Junte-se a terapeutas que já usam o Agenda Online AI para cuidar melhor dos seus pacientes.</p>
