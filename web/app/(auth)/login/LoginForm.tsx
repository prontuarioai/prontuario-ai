  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4">
      ...
      <div className="relative">
        ...
        <div className="relative flex justify-center text-xs text-gray-400 bg-gray-50 dark:bg-gray-900 px-2">
          ou continue com
        </div>
      </div>
      ...
      <button
        ...
        className="w-full flex items-center justify-center gap-2 border border-gray-300 rounded-xl py-2.5 text-sm font-medium text-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:bg-gray-900 transition-colors"
      >
