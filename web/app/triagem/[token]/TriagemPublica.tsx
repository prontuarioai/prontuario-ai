    ...
    <div className="bg-white rounded-2xl border border-gray-100 p-6 space-y-6">
      ...
      {step === 1 && (
        <div className="space-y-6">
          <div>
            <h2 className="font-semibold text-gray-900 mb-1">Como você está se sentindo hoje?</h2>
            <p className="text-sm text-gray-500">Selecione um número de 1 a 10</p>
          </div>
          <div className="space-y-4">
            ...
            <div className="text-center text-sm text-gray-600 bg-gray-50 rounded-xl py-2">
              {humorLabels[humor]}
            </div>
          </div>
          <button
      ...
      {step === 2 && (
        <div className="space-y-5">
          <div>
            <h2 className="font-semibold text-gray-900 mb-1">Aconteceu algo relevante desde a última sessão?</h2>
            <p className="text-sm text-gray-500">Pode ser algo positivo ou negativo. Campo opcional.</p>
          </div>
          <textarea
            value={eventos}
      ...
      {step === 3 && (
        <div className="space-y-5">
          <div>
            <h2 className="font-semibold text-gray-900 mb-1">O que você gostaria de trabalhar hoje?</h2>
            <p className="text-sm text-gray-500">Qual é o foco ou intenção para esta sessão? Campo opcional.</p>
          </div>
          <textarea
            value={foco}
          ...
          <div className="flex gap-3">
            <button onClick={() => setStep(2)} className="flex-1 border border-gray-200 text-gray-600 py-2.5 rounded-xl text-sm hover:bg-gray-50 transition-colors">
              Voltar
            </button>
            <button
