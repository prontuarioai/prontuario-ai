  ...
  return (
    <div className="min-h-screen bg-white">
      <div className="max-w-3xl mx-auto px-6 py-16 space-y-10">
        ...
        <section className="space-y-3">
          <h2 className="text-lg font-semibold text-gray-900">3. Como usamos os dados do Google</h2>
          <div className="space-y-2 text-gray-600 leading-relaxed">
        ...
        <section className="space-y-3">
          <h2 className="text-lg font-semibold text-gray-900">5. Segurança e retenção</h2>
          <p className="text-gray-600 leading-relaxed">
        ...
        <section className="space-y-3">
          <h2 className="text-lg font-semibold text-gray-900">6. Direitos do usuário (LGPD)</h2>
          <p className="text-gray-600 leading-relaxed">
