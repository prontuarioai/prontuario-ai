  ...
  return (
    <div className="bg-white rounded-2xl border border-gray-100 p-6 space-y-5">
      <div className="flex items-center gap-2">
        ...
        <div>
          <h2 className="font-semibold text-gray-900">Prontuário clínico</h2>
      ...
      <form action={handleAction} className="space-y-4">
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <div>
            ...
            <div className="flex items-center rounded-xl border border-gray-300 overflow-hidden focus-within:ring-2 focus-within:ring-brand-500">
              <span className="px-3 py-2.5 text-xs text-gray-400 bg-gray-50 border-r border-gray-200 shrink-0">R$</span>
              <input
                name="valor_consulta"
                type="number"
                step="0.01"
        ...
        <div>
          <label className="block text-sm font-medium text-gray-700 mb-1">Queixa principal / Motivo de consulta</label>
          <textarea
