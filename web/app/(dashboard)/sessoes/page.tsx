    ...
    <div className="p-6 max-w-4xl mx-auto space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-gray-500 dark:text-gray-400 mt-0.5">{sessoes?.length ?? 0} encontradas</p>
        </div>
        <Link
          href="/agenda"
          ...
          {sessoes.map((s: any) => (
            ...
            >
              <div className="text-center min-w-[48px]">
                ...
                <p className="text-xl font-bold text-gray-900 dark:text-white leading-none">{new Date(s.inicio).getDate()}</p>
              </div>
              ...
              <span className={`text-xs font-medium px-2.5 py-1 rounded-full ${STATUS_COLOR[s.status] ?? 'bg-gray-100 dark:bg-gray-700 text-gray-500 dark:text-gray-400'}`}>
