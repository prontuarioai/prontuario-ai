    ...
    <div className="space-y-4">
      ...
      {!loading && items.length === 0 && (
        <div className="text-center py-12 space-y-2">
          ...
          <p className="text-sm text-gray-500">Nenhuma mensagem por enquanto</p>
        </div>
      )}
      ...
      {items.map(item => {
        ...
        return (
          <div key={item.id} className="border border-gray-200 rounded-2xl p-4 bg-white space-y-3">
            ...
            <div>
              <p className="text-xs font-semibold text-gray-500 mb-0.5">{item.autorNome}</p>
            ...
            <div className="flex items-center gap-2">
              ...
              {podeResponder && !isRespondendo && (
                <button
                  ...
                  className="text-xs text-gray-500 hover:text-gray-800 border border-gray-200 rounded-lg px-2.5 py-1 transition-colors"
                >
                  Responder
                </button>
              )}
