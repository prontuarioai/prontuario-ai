...
export default function AuditLogsSection({ logs }: { logs: AuditLog[] }) {
  if (logs.length === 0) {
    return (
      <section className="bg-white rounded-2xl border border-gray-200 p-6">
        <h2 className="text-base font-semibold text-gray-900 mb-2">Registro de atividades</h2>
  ...
  return (
    <section className="bg-white rounded-2xl border border-gray-200 p-6 space-y-4">
      <div>
        <h2 className="text-base font-semibold text-gray-900">Registro de atividades</h2>
        <p className="text-sm text-gray-500">Últimas ações realizadas na clínica</p>
      </div>
