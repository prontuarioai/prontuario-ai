  ...
  return (
    <div className="bg-white rounded-2xl border border-gray-200 p-6 space-y-4">
      <div className="flex items-center justify-between">
        <div>
          <h2 className="font-semibold text-gray-900">WhatsApp da Secretária</h2>
        ...
        <div className="space-y-3">
          ...
          {qr ? (
            <div className="flex justify-center">
              <img src={qr} alt="QR Code WhatsApp Secretária" className="w-48 h-48 rounded-xl border border-gray-200" />
            </div>
          ) : (
          ...
          <button onClick={init} className="text-sm text-gray-500 hover:text-gray-700 transition-colors">
            Atualizar
          </button>
        </div>
      )}
